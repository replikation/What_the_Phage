process virsorter {
    ...
    script:
      ...
      cat virsorter/Predicted_viral_sequences/VIRSorter_cat-[${params.vs_filter}].fasta | grep ">" | sed -e s/\\>VIRSorter_//g | sed -e s/-cat_1//g |  sed -e s/-cat_2//g | sed -e s/-cat_3//g | sed -e s/-circular//g > virsorter_\${PWD##*/}.list
