process contigs_by_tools {
    ...
    output:
        tuple val(name), path("${name}_contig_tool_p-value_overview.tsv"), emit: overview_ch, optional: true
    ...
    script:
        ...
        mv contig_tool_p-value_overview.tsv ${name}_contig_tool_p-value_overview.tsv
