process phabox2_annotation {
    ...
    script:
        ...
        cp ${name}_results_annotation/final_prediction/phavip_supplementary/gene_annotation.tsv .
        mv gene_annotation.tsv ${name}_gene_annotation_phabox2.tsv  

        # zip for export
        tar -czf ${name}_phabox2_annotation_output.tar.gz ${name}_results_annotation
